...
public class AuthorServices {
	...
	public ResponseParms createBook(BooksDetails book) {
		...
		ResponseParms params=restTemplate.postForObject("http://localhost:2222/app/v1/digitalbooks/author/books", entity, ResponseParms.class);
		return params;
	}
	...
	public ResponseParms upadteBook(BooksDetails book) {
		...
		headers.setContentType(MediaType.APPLICATION_JSON);
		HttpEntity<BooksDetails> entity = new HttpEntity<BooksDetails>(book, headers);
		ResponseParms params=restTemplate.postForObject("http://localhost:2222/app/v1/digitalbooks/author/books/"+book.getBookId(), entity, ResponseParms.class);
		return params;
	}
	...
	public ResponseParms blockUnblockBook(Long authorid, Long bookid, String block) {
		...
		HttpHeaders headers = new HttpHeaders();
		headers.setContentType(MediaType.APPLICATION_JSON);
		ResponseParms params=restTemplate.postForObject("http://localhost:2222/app/v1/digitalbooks/author/books/"+authorid+"/"+bookid+"/?block="+block, headers, ResponseParms.class);
		return params;
	}
